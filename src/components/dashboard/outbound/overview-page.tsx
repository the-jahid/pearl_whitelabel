          ...
          {campaigns.length > 0 ? (
            <div className="p-3 sm:p-4 lg:p-6 border-b border-gray-200">
              <div className="space-y-3 sm:space-y-4">
                <div>
                  <label className="block text-xs sm:text-sm font-medium text-gray-700 mb-2">Campaign</label>
            ...
            <div className="p-3 sm:p-4 lg:p-6 border-b border-gray-200">
              <div className="text-center py-4">
                <p className="text-xs sm:text-sm text-gray-500 mb-2">No campaigns available</p>
